...
module Calculator =  
    type SH_R = 
        Provided.TypeProviderFile<"../../../Examples/SH/Protocols/SH.scr", "SH", "R", "../../../Examples/SH/Config/configR.yaml"
            ,SHData.delims, SHData.typeAliasing, ScribbleSource.LocalExecutable, AssertionsOn=true>
    ...
    let c = sh_r.Init()//.receivehello(P, res1).sendhello(P, 1)
    c.receivePlane(P, res1, res2, res3, res4) |> calculate

module Producer = 
    type SH_P = 
        Provided.TypeProviderFile<"../../../Examples/SH/Protocols/SH.scr", "SH" ,"P" , "../../../Examples/SH/Config/configP.yaml", SHData.delims 
    ...
    let sh = new SH_P()
    let rec calcClipPoints (vert: int list)  (c:SH_P.State36) =
        let res1 = new DomainModel.Buf<int>()    
        let res2 = new DomainModel.Buf<int>()    
        let res3 = new DomainModel.Buf<int>()    
        match vert with 
...
module Consumer = 
    type SH_C = 
        Provided.TypeProviderFile<"../../../Examples/SH/Protocols/SH.scr","SH", "C" ,"../../../Examples/SH/Config/configC.yaml" 
    ...
    let rec printPoints (c:SH_C.State20) =
