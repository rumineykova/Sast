...
module Calculator =  
    type SH_R = 
        Provided.TypeProviderFile<"../../../Examples/SH/FSM/ShFSM_R.txt", "SH", "R", "../../../Examples/SH/Config/configR.yaml"
            ,SHData.delims, SHData.typeAliasing, ScribbleSource.File, AssertionsOn=true>
...
module Producer = 
    type SH_P = 
        Provided.TypeProviderFile<"../../../Examples/SH/FSM/ShFSM_P.txt", "SH" ,"P" , "../../../Examples/SH/Config/configP.yaml", SHData.delims 
            ,SHData.typeAliasing, ScribbleSource.File, AssertionsOn = true>
...
module Consumer = 
    type SH_C = 
        Provided.TypeProviderFile<"../../../Examples/SH/FSM/ShFSM_C.txt","SH", "C" ,"../../../Examples/SH/Config/configC.yaml" 
            ,Delimiter = SHData.delims ,TypeAliasing = SHData.typeAliasing ,ScribbleSource = ScribbleSource.File, AssertionsOn = true>
